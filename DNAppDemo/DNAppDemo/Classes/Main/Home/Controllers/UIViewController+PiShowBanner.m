...
#define kPiShowBannerTop (0)
#define kPiShowBannerHeight (20)
...
- (void)showBannerWithMessage:(NSString *)msg belowView:(UIView *)topView belowTop:(CGFloat)top autoHideIn:(NSTimeInterval)secs withCompletion:(void (^)())completion {
    ...
    [container bringSubviewToFront:self.view.window];
...
- (UIView *)getBannerWithMessage:(NSString *)msg {
    ...
    bannerContainer.backgroundColor = [[UIColor colorWithHexString:@"0xffba26"] colorWithAlphaComponent:0.95];
