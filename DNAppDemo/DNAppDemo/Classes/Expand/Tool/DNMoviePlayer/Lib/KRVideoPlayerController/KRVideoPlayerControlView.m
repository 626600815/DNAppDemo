...
- (void)layoutSubviews
{
    ...
    self.closeButton.frame = CGRectMake(CGRectGetWidth(self.topBar.bounds) - CGRectGetWidth(self.closeButton.bounds), CGRectGetMinX(self.topBar.bounds), 30, 30);
...
- (UIButton *)closeButton
{
    if (!_closeButton) {
        ...
        [_closeButton setBackgroundImage:[UIImage imageNamed:[self videoImageName:@"kr-video-player-close"]] forState:UIControlStateNormal];
